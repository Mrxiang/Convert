...
//                        System.out.println("属性名：" + attrName + "----属性值："+ attrValue);
    ...
    public void convertStringWithDictonary( File inFile,  Map<String,String> map)throws  IOException{
        ...
        File targetFile = new File(  inFileDir + File.separator + Utils.TARGET );
...
//        }
        ...
        String outFilePath = inFilePath.getParentFile().getPath()+File.separator+ Utils.VALUE_PATH+File.separator+ Utils.TARGET;
